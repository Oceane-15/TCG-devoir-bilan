<?php
if (!isset($panierResume)) { $panierResume = panier_resume(); }
?>
        ...
        <div class="panier-ligne">
            ...
            <div class="panier-ligne__infos">
                ...
                <div class="panier-ligne__quantite">
                    <form action="index.php?route=panier-modifier" method="post" data-ajax-panier="modifier">
                        <?= csrf_field() ?>
            ...
            <div class="panier-ligne__droite">
                <form action="index.php?route=panier-supprimer" method="post" data-ajax-panier="supprimer">
                    <?= csrf_field() ?>
                    <input type="hidden" name="produit_id" value="<?= e($p['produit_id']) ?>">
