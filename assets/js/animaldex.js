document.addEventListener('DOMContentLoaded', function () {
    ...
    function filtrer() {
        ...
        casesRarete.forEach(function (c) {
            if (c.checked) { raretesActives.push(c.value); }
        });
        ...
        cartes.forEach(function (carte) {
            ...
            var correspondRarete = (raretesActives.length === 0)
                || (raretesActives.indexOf(rarete) !== -1);
    ...
    casesRarete.forEach(function (c) { c.addEventListener('change', filtrer); });
});